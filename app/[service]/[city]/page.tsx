...
const SERVICE_NAMES: Record<Service, { name: string; title: string }> = {
  "abogado-divorcio": { name: "Abogado de Divorcio", title: "Abogados Divorcio" },
  "abogado-herencias": { name: "Abogado de Herencias", title: "Abogados Herencias" },
  "abogado-accidentes": { name: "Abogado de Accidentes", title: "Abogados Accidentes" },
  "abogado-laboral": { name: "Abogado Laboral", title: "Abogados Laboralistas" },
  "abogado-penal": { name: "Abogado Penalista", title: "Abogados Penalistas" },
  "abogado-extranjeria": { name: "Abogado de Extranjería", title: "Abogados Extranjería" },
  "abogado-familia": { name: "Abogado de Familia", title: "Abogados Familia" },
  "abogado-civil": { name: "Abogado Civil", title: "Abogados Civilistas" },
  "abogado-inmobiliario": { name: "Abogado Inmobiliario", title: "Abogados Inmobiliarios" },
  "abogado-empresas": { name: "Abogado de Empresas", title: "Abogados Empresas" },
}
