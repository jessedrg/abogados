// =============================================================================
// SITEMAP DATA - ABOGADOS
// =============================================================================
// Servicios legales en España - 8118 municipalities
// =============================================================================
...
// =============================================================================
// HIGH-INTENT KEYWORD MODIFIERS - Sector Legal
// =============================================================================
export const MODIFIERS = [
  "",
  // ============ URGENCIA ============
  "-urgente", "-ahora", "-hoy", "-rapido", "-24-horas",
  
  // ============ PRECIO ============
  "-precios", "-economico", "-barato", "-gratis-consulta",
  "-primera-consulta-gratis", "-cuanto-cobra",
  
  // ============ CALIDAD ============
  "-mejor", "-recomendado", "-especialista", "-experto",
  "-de-confianza", "-mejor-valorado",
  
  // ============ PAGO ============
  "-pago-resultado", "-sin-adelanto", "-facilidades-pago",
  
  // ============ UBICACIÓN ============
  "-cerca-de-mi", "-online", "-telefono",
  
  // ============ ESPECÍFICO DIVORCIO ============
  "-mutuo-acuerdo", "-express", "-con-hijos", "-custodia",
  
  // ============ ESPECÍFICO HERENCIAS ============
  "-testamento", "-sucesiones", "-declaracion-herederos",
  
  // ============ ESPECÍFICO ACCIDENTES ============
  "-trafico", "-indemnizacion", "-lesiones",
  
  // ============ COMBOS ============
  "-urgente-economico", "-gratis-urgente", "-especialista-economico",
] as const;
...
export const PROBLEMS: Record<Service, readonly string[]> = {
  ...
  "abogado-herencias": [
    "fallecio-familiar", "testamento", "herencia-sin-testamento",
    "impuesto-sucesiones", "repartir-herencia", "deudas-herencia",
  ],
  "abogado-accidentes": [
    "accidente-coche", "accidente-moto", "atropello",
    "accidente-trabajo", "negligencia-medica", "indemnizacion",
  ],
  "abogado-laboral": [
  ...
  "abogado-extranjeria": [
    "permiso-residencia", "nacionalidad", "arraigo",
    "reagrupacion-familiar", "NIE", "renovacion-papeles",
  ],
  "abogado-familia": [
  ...
  "abogado-civil": [
    "reclamar-deuda", "contrato", "comunidad-vecinos",
    "responsabilidad-civil", "daños-perjuicios",
  ],
  "abogado-inmobiliario": [
    "compraventa", "alquiler", "desahucio", "hipoteca",
    "clausula-suelo", "okupas",
  ],
  "abogado-empresas": [
